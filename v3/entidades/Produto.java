...
public class Produto {
		...
		public Produto(Integer cod_produto, String nome_produto,
				String descricao_produto,
				double valor_unitario, Date data_fabricacao, Categoria categoria,
				Funcionario funcionario, Integer quant_estoque) {
			super();
