...
insert into produto (id, nome, categoria_id, descricao, data_fabricacao, quantidade_estoque, valor_unitario, funcionario_id) values

	(1,'Narnia', 1, 'Livro sobre um mundo magico', TO_DATE('12-01-2019','dd-MM-yyyy'), '10', '30', 1);
